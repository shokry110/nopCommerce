...
public static partial class NopCommonDefaults
{
    ...
    #region sarayetel official site

    /// <summary>
    /// Gets a path to request the sarayetel official site for any recommendations/warnings
    /// </summary>
    /// <remarks>
    /// {0} : store URL
    /// {1} : sarayetel version
    ...
    /// <summary>
    /// Gets a path to request the sarayetel official site for license compliance check
    /// </summary>
    /// <remarks>
    /// {0} : store URL
    /// {1} : sarayetel version
    ...
    /// <summary>
    /// Gets a path to request the sarayetel official site for news RSS
    /// </summary>
    /// <remarks>
    /// {0} : sarayetel version
    ...
    /// {4} : language code
    /// </remarks>
    public static string NopNewsRssPath => "sarayetel-news-rss?version={0}&localhost={1}&hideAdvertisements={2}&storeUrl={3}&language={4}";

    /// <summary>
    /// Gets a path to request the sarayetel official site to notify about successful installation
    /// </summary>
    /// <remarks>
    /// {0} : sarayetel version
    /// {1} : whether the store based is on the localhost
    ...
    /// <summary>
    /// Gets a path to request the sarayetel official site to subscribe to the sarayetel newsletters
    /// </summary>
    /// <remarks>
    /// {0} : subscriber email
    /// </remarks>
    ...
    /// <summary>
    /// Gets a path to request the sarayetel official site for available categories of marketplace extensions
    /// </summary>
    /// <remarks>
    /// {0} : language code
    /// </remarks>
    ...
    /// <summary>
    /// Gets a path to request the sarayetel official site for available versions of marketplace extensions
    /// </summary>
    /// <remarks>
    /// {0} : language code
    /// </remarks>
    ...
    /// <summary>
    /// Gets a path to request the sarayetel official site for marketplace extensions
    /// </summary>
    /// <remarks>

...
public class LocalizationMigration : MigrationBase
{
    ...
    public override void Up()
    {
        ...
        localizationService.AddOrUpdateLocaleResource(new Dictionary<string, string>
        {
            ...
            //#7398
            ["Admin.ConfigurationSteps.Product.Details.Text"] = "Enter the relevant product details in these fields. The screenshot below shows how they will be displayed on the product page with the default sarayetel theme: <div class=\"row row-cols-1\"><img class=\"img-thumbnail mt-3\" src=\"/js/admintour/images/product-page.jpg\"/></div>",

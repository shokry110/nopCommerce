...
1. In 4.60, we have moved customer related fields from the "GenericAttribute" table to the "Customer" table (see details in https://github.com/nopSolutions/sarayetel/issues/4601). 
